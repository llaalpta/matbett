...
const RewardEntityCommonFieldsSchema = z.object({
  ...
  nextQualifyDeadline: z.date().nullable().optional(),
  usageTimeframeEnd: z.date().nullable().optional(),
});
...
export const RewardListInputSchema = PaginationInputSchema.extend({
  status: RewardStatusSchema.optional(),
  type: z
    .enum([
      'FREEBET',
...
export type RewardListInput = z.infer<typeof RewardListInputSchema>;
