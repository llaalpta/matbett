...
export const bookmakerAccountTypeOptions = [
  { value: "SPORTSBOOK", label: "Bookmaker" },
  { value: "EXCHANGE", label: "Exchange" },
] as const satisfies readonly SelectOption<string>[];
export type BookmakerAccountType =
  (typeof bookmakerAccountTypeOptions)[number]["value"];
...
export const strategyKindOptions = [
  { value: "NONE", label: "Sin cobertura" },
  { value: "HEDGE", label: "Con cobertura" },
] as const satisfies readonly SelectOption<string>[];
export type StrategyKind = (typeof strategyKindOptions)[number]["value"];

export const strategyTypeOptions = [
  { value: "MATCHED_BETTING", label: "Matched Betting" },
  { value: "DUTCHING", label: "Arbitraje" },
] as const satisfies readonly SelectOption<string>[];
export type StrategyType = (typeof strategyTypeOptions)[number]["value"];
...
export const betParticipationKindOptions = [
  { value: "QUALIFY_TRACKING", label: "Participa en calificación" },
  { value: "REWARD_USAGE", label: "Participa en uso de reward" },
] as const satisfies readonly SelectOption<string>[];
export type BetParticipationKind = (typeof betParticipationKindOptions)[number]["value"];

export const depositParticipationRoleOptions = [
  { value: "QUALIFY_TRACKING", label: "Participa en calificación" },
] as const satisfies readonly SelectOption<string>[];
export type DepositParticipationRole =
  (typeof depositParticipationRoleOptions)[number]["value"];

export const hedgeAdjustmentTypeOptions = [
  { value: "UNMATCHED", label: "Ajuste por unmatched" },
  { value: "PREPAYMENT", label: "Ajuste por prepayment" },
] as const satisfies readonly SelectOption<string>[];
export type HedgeAdjustmentType =
  (typeof hedgeAdjustmentTypeOptions)[number]["value"];
...
export type PromotionCardinality =
  (typeof promotionCardinalityOptions)[number]["value"];
...
export type PromotionAnchorEvent =
  (typeof promotionAnchorEventOptions)[number]["value"];
...
export type PhaseAnchorEvent =
  (typeof phaseAnchorEventOptions)[number]["value"];
...
export type ActivationMethod =
  (typeof activationMethodOptions)[number]["value"];
...
export const rewardStatusOptions = [
  ...
  {
    value: "PENDING_TO_CLAIM",
    label: "Condiciones cumplidas - Pendiente de reclamar",
  },
...
export type RewardAnchorEvent =
  (typeof rewardAnchorEventOptions)[number]["value"];

export const rewardValueTypeOptions = [
  { value: "FIXED", label: "Valor fijado en la promoción" },
...
export const enhancedOddsModeOptions = [
  { value: "FIXED", label: "Cuota mejorada fijada por promoción" },
  { value: "PERCENTAGE", label: "Porcentaje sobre cuota inicial" },
] as const satisfies readonly SelectOption<string>[];
export type EnhancedOddsMode = (typeof enhancedOddsModeOptions)[number]["value"];
...
export type QualifyConditionType =
  (typeof qualifyConditionTypeOptions)[number]["value"];
...
export type QualifyConditionStatus =
  (typeof qualifyConditionStatusOptions)[number]["value"];
...
export type QualifyConditionAnchorEvent =
  (typeof qualifyConditionAnchorEventOptions)[number]["value"];
...
export const rewardQualifyConditionRoleOptions = [
  ...
  {
    value: "QUALIFY_FOR_ENHANCED_ODDS",
    label: "Calificar para Cuotas Mejoradas",
  },
] as const satisfies readonly SelectOption<string>[];
export type RewardQualifyConditionRole =
  (typeof rewardQualifyConditionRoleOptions)[number]["value"];
...
export type BetTypeRestriction =
  (typeof betTypeRestrictionOptions)[number]["value"];
...
export type RequiredBetOutcome =
  (typeof requiredBetOutcomeOptions)[number]["value"];

export const rolloverContributionWalletOptions = [
  { value: "MIXED", label: "Mixto (real + bono)" },
  { value: "BONUS_ONLY", label: "Solo saldo de bono" },
  { value: "REAL_ONLY", label: "Solo saldo real" },
] as const satisfies readonly SelectOption<string>[];
export type RolloverContributionWallet =
  (typeof rolloverContributionWalletOptions)[number]["value"];

export const cashbackCalculationMethodOptions = [
  { value: "NET_LOSS", label: "Perdida neta (compensada)" },
  { value: "GROSS_LOSS", label: "Perdida bruta (sin compensar)" },
  { value: "STAKES_ONLY", label: "Importe apostado (stake)" },
] as const satisfies readonly SelectOption<string>[];
export type CashbackCalculationMethod =
  (typeof cashbackCalculationMethodOptions)[number]["value"];
...
export type SystemTypeRestriction =
  (typeof systemTypeRestrictionOptions)[number]["value"];
...
export type CashbackRewardPeriodType =
  (typeof cashbackRewardPeriodTypeOptions)[number]["value"];
...
export type RewardFormatType =
  (typeof rewardFormatTypeOptions)[number]["value"];
...
export const timeframeModeOptions = [
  ...
  { value: "RELATIVE", label: "Realtivo a un evento" },
...
export type AnchorEvent =
  | RewardAnchorEvent
  | PhaseAnchorEvent
  | PromotionAnchorEvent
  | QualifyConditionAnchorEvent;

export function getAnchorEventLabel(
  entityType: EntityType,
  event: string,
): string {
  const findLabel = (options: readonly SelectOption<string>[]) =>
    options.find((option) => option.value === event)?.label;

  switch (entityType) {
    case "PROMOTION":
      return findLabel(promotionAnchorEventOptions) ?? event;
    case "PHASE":
      return findLabel(phaseAnchorEventOptions) ?? event;
    case "REWARD":
      return findLabel(rewardAnchorEventOptions) ?? event;
    case "QUALIFY_CONDITION":
      return findLabel(qualifyConditionAnchorEventOptions) ?? event;
    default:
      return event;
  }
}
...
export function getValues<T extends string>(
  ...
  const values: [T, ...T[]] = [options[0].value];
