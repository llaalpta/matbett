export * from "./PromotionBasicInfoForm";
...
export * from "./DepositWarnings"; // Warnings para depósitos

// Exportaciones de las condiciones específicas
export * from "./conditions/DepositCondition"; // Renombrado
export * from "./conditions/QualifyBetCondition";
export * from "./conditions/LossesCashbackCondition";
