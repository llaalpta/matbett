...
export type RewardListResponse = RouterOutputs["reward"]["list"];
...
export type BetBatchFormData = RouterInputs['bet']['registerBetsBatch'];
export type BetBatchUpdateFormData = RouterInputs['bet']['updateBatch']['data'];
export type BetBatchServerModel = RouterOutputs['bet']['getBatch'];
export type BetBatchListResponse = RouterOutputs['bet']['listBatches'];
export type BetFlatListResponse = RouterOutputs['bet']['listBets'];
export type BetAvailablePromotionContexts =
  RouterOutputs['bet']['getAvailablePromotionContexts'];
export type BookmakerAccountFormData = RouterInputs["bookmakerAccount"]["create"];
export type BookmakerAccountServerModel =
  RouterOutputs["bookmakerAccount"]["getById"];
export type BookmakerAccountListResponse = RouterOutputs['bookmakerAccount']['list'];
