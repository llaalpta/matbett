...
- Detailed, function-by-function dependency and trigger analysis is documented in:
  - [`matched-betting-calculation-dependency-map.md`](./matched-betting-calculation-dependency-map.md)
- That document maps each current calculation function to:
  - form configuration
